...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <h1>REGISTRATION</h1>
    <form class="col-3 offset-4 border rounded" method="POST" action="{{(route('registration'))}}">
        @csrf
        ...
        <div class="form-group">
            <button class="btn btn-lg btn-primary" type="submit" name="Send" value="1">Registration</button>
        </div>
    </form>
    </body>
</html>
